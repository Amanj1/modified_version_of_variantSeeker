...
process map_reads_to_contigs{
  ...
  input:
  set sample_id, megahit_contigs, read_PE_1, read_PE_2, read_single  from map_reads_to_contigs
...
process blastn_phase2_megahit{
  ...
  script:
""" 
/media/lalo/da2ae0b2-e696-4533-b28d-717986cfc6e1/Diabetes_individual_samples/variantSeeker_individual_samples_diabetes_date220815/ncbi-blast-2.13.0+-x64-linux/ncbi-blast-2.13.0+/bin/blastn -db ${params.large_db_nucl} -query ${reads} -num_threads ${task.cpus} -outfmt 6 > "${sample_id}_blastn_phase2_megahit.out"
"""
}
